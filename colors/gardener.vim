...
" Colors for the User Interface.
    ...
    " the following totally messes up normal stuff
    ...
    hi NonText        cterm=NONE   ctermfg=230   ctermbg=239
    ...
    hi StatusLine     cterm=NONE   ctermfg=16    ctermbg=229
    hi StatusLineNC   cterm=BOLD   ctermfg=255   ctermbg=167
    hi VertSplit      cterm=NONE   ctermfg=16    ctermbg=229

    hi DiffAdd        cterm=NONE   ctermfg=255   ctermbg=60
    hi DiffAdd        cterm=NONE   ctermfg=255   ctermbg=65
    hi DiffAdd        cterm=NONE   ctermfg=255   ctermbg=95
    ...
    hi String         cterm=NONE   ctermfg=230  ctermbg=238
